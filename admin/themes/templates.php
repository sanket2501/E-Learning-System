                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="<?php echo web_root; ?>admin/modules/exercises/index.php"><i class="menu-icon icon-inbox"></i>Exercises 
                                     </a></li> 
                            </ul>
                            <!--/.widget-nav-->
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a href="<?php echo web_root; ?>admin/modules/galery/index.php"><i class="menu-icon icon-bold"></i> Lesson Galery </a></li>
